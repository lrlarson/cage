	  ...
	  //set up listening window
	   google.maps.event.addListener(marker,'click',(function(marker, i){
        return function(){
			...
			content = content + '<br /> (10 seconds of silence btwn. movements)';
			//for (x=1;x<4;x++)	{
			...
			//embed player here
			embedContent = '';
			embedContent = '<br /> <OBJECT CLASSID="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B';
			embedContent += 'WIDTH="290"HEIGHT="20"CODEBASE="http://www.apple.com/qtactivex/qtplugin.cab">';
			embedContent += '<PARAM name="SRC" VALUE="' + url + '"><PARAM name="AUTOPLAY" VALUE="false"><PARAM name="CONTROLLER" VALUE="true">';
			embedContent += '<EMBED src="' + url + '" WIDTH="290" HEIGHT="10" AUTOPLAY="false" CONTROLLER="ture" PLUGINSPAGE="http://www.apple.com/quicktime/download/">';
			embedContent += '</EMBED></OBJECT> <br />';
			embedContent += ' <br />';
			embedContent += ' <br />';
