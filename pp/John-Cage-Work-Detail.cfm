...
<cfparam name="work_ID"  default="17">
...
<div class="content">
<cfoutput> 
<table width="100%" border="0"  cellpadding="10" class="tableTop" style="">
  <tr>
    <td class="labelCell" height="30"  >Work Details</td>
  </tr>
...
<table width="100%" height="300px" id="detailsTable"    >
...
<table width="330px" border="0"  cellpadding="10" style="" class="tableTop">
  <tr id="recordingHeader">
    ...
    <td class="labelCell"  height="30"  >Recordings Summary <em style="font-size: small; color: #999;">(click for details)</em></td>
