...
<li><a href="../events/events.html" title="Cage Related Events">Calendar of Events</a></li><br />
...
<table width="100%" border="0"  cellpadding="10" style="" class="tableTop">
  <tr>
    <td height="30" class="labelCell" >Work Summary</td>
    <td width="150" class="labelCell" style="background-color:#575757;"><span id="detailLink"> Permalink</span></td>
  </tr>
</table>
<div class="workDetails" id="workDetails" style="background-color: #fff;" >
    	<div id="scalarDetails"  >
        <div id="pleaseClick">
        	<table id="pleaseClickTable" width="100%" >
  		<tr class="danceRow">
        <!--- height below shoud be 644px--->
        <td class="tableRegularCell" style="color:#999; padding-top:15px; height: 32px; font-style: oblique; font-size: 15px;"  >&#8592; Click on a work title to view a summary</td>
        </tr>
       </table>
